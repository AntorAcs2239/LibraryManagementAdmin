...
public class BooksAdapter extends RecyclerView.Adapter<BooksAdapter.viewholde>{
    ...
    Context context;
    ArrayList<BooksDetails> list=new ArrayList<>();
    ArrayList<BooksDetails> filterdata=new ArrayList<>();
    public Onclickliten onclickliten;
    public interface Onclickliten
    {
        void onclick(BooksDetails booksmode);
        void longpress(BooksDetails Booksmode);
    }
    public void setOnclickliten(Onclickliten onclickliten) {
        this.onclickliten = onclickliten;
    }
    public BooksAdapter(Context context, ArrayList<BooksDetails> list) {
    ...
    public void onBindViewHolder(@NonNull viewholde holder, int position) {
        BooksDetails booksModel=list.get(position);
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                onclickliten.longpress(booksModel);
                return true;
            }
        });
    }
    ...
    public void filter(ArrayList<BooksDetails>backup)
    {
        list=backup;
