...
public class PendingBookAdapter extends RecyclerView.Adapter<PendingBookAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull viewholder holder, int position) {
        ...
        holder.bookname.setText("Book Name: "+pendingbookmodel.getBookname());
        holder.writername.setText("Writer Name: "+pendingbookmodel.getWritername());
        holder.studentname.setText("Student Name: "+pendingbookmodel.getStudentname());
        holder.studentphone.setText("Student Phone: "+pendingbookmodel.getStudentphone());
...
//        holder.time.setText(pendingbookmodel.getDate());
    ...
    public class viewholder extends RecyclerView.ViewHolder {
        ImageView imageView;
        TextView bookname,writername,time,studentname,studentphone;
        public viewholder(@NonNull View itemView) {
            super(itemView);
            imageView=itemView.findViewById(R.id.img);
            bookname=itemView.findViewById(R.id.bname);
            writername=itemView.findViewById(R.id.wname);
            studentname=itemView.findViewById(R.id.studentnamepending);
